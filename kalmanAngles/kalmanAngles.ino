...
{ 
      ...
      LOG_PORT.print(imu.calcGyro(imu.gx));     // gyro
      LOG_PORT.print("\t");
      LOG_PORT.print(imu.calcGyro(imu.gy));
      LOG_PORT.print("\t");
      LOG_PORT.print(imu.calcGyro(imu.gz));
      LOG_PORT.print("\t");

      LOG_PORT.print(imu.calcMag(imu.mx));     // mag
      LOG_PORT.print("\t");
      LOG_PORT.print(imu.calcMag(imu.my));     
      LOG_PORT.print("\t");
      LOG_PORT.print(imu.calcMag(imu.mz));     
      LOG_PORT.print("\t");

      LOG_PORT.print(imu.pitch, 2);             // Euler calcs
      LOG_PORT.print("\t");
      imuLog += String(imu.roll, 2) + ", ";
      LOG_PORT.print("\t");
      LOG_PORT.print(imu.yaw, 2);
